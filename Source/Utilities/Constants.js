...
export const ACTIVATION_TOKEN_EXPIRY = PROCESS.env.ACTIVATION_TOKEN_EXPIRY;
export const AUTHENTICATION_TOKEN_SECRET = PROCESS.env.AUTHENTICATION_TOKEN_SECRET;
export const AUTHENTICATION_TOKEN_EXPIRY = PROCESS.env.AUTHENTICATION_TOKEN_EXPIRY;
